...
import 'package:fruit_hub_dashboard/features/add_product/presentation/views/add_product_view_body_bloc_consumer.dart';
...
class AddProductView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            AddProductCubit(getIt<ImageRepo>(), getIt<ProductRepo>()),
        child: SafeArea(child: AddProductViewBodyBlocConsumer()),
      ),
    );
  }
}
