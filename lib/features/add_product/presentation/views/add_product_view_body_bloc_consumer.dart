...
import 'package:fruit_hub_dashboard/core/utils/custom_progress_hud.dart';
    ...
    return BlocConsumer<AddProductCubit, AddProductState>(
      listener: (context, state) {
        if (state is AddProductSuccess) {
          buildBar(context, 'Product added successfully!', Colors.green);
          Navigator.pop(context);
        }
        if (state is AddProductFailure) {
          buildBar(context, state.errorMessage, Colors.red);
        }
      },
